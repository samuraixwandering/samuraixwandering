...
**9** merged PRs in other people's repos.

| Project | Merged |
| --- | --- |
| [spiffe/spire](https://github.com/spiffe/spire) | 7 |
...
- [spiffe/spire#7203](https://github.com/spiffe/spire/pull/7203) test: add tpm_devid integration suite backed by a software TPM <sub>2026-08-25</sub>
- [spiffe/spire#7197](https://github.com/spiffe/spire/pull/7197) Make the vault and broker-api-k8s integration suites runnable on macOS <sub>2026-08-08</sub>
- [rust-lang/libc#5358](https://github.com/rust-lang/libc/pull/5358) apple: add `netinet/tcp.h` flag and option constants <sub>2026-08-04</sub>
...
<sub>Updated 2026-09-05 · [all merged PRs](https://github.com/search?q=is%3Apr+author%3Asamuraixwandering+is%3Amerged&type=pullrequests)</sub>
